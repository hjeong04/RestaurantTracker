...
// Represents a writer that writes JSON representation of restaurantlist to file
public class JsonWriter {
    ...
    // MODIFIES: this
    // EFFECTS: opens writers; throws FileNotFoundException if destination file cannot be opened for writing
